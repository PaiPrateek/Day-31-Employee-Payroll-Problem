...
--updating the phone, address and department field 
update employee_payroll
set departmentID = 2  where name = 'Prateek'

update employee_payroll
set departmentID = 1 where name = 'Manjesh'

update employee_payroll
set departmentID =  1 where name = 'Suhas'

update employee_payroll
set departmentID =  3 where name = 'Prajwal'

update employee_payroll
set departmentID = 3  where name = 'Sanath'

update employee_payroll
set departmentID =  2  where name = 'Rakesh'
